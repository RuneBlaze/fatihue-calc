	...
	function App(sources) {
	  ...
	  var sinks = {
	    DOM: fatihue$.map(function (_ref3) {
	      ...
	      return (0, _dom.div)('.container', [(0, _dom.h1)('Hearthstone Mill Rogue Lethal Calculator'), (0, _dom.p)('This calculator helps the inexperienced mill rogue players (like me) determine lethal.'), (0, _dom.p)('All number parameters are by default 0.'), (0, _dom.blockquote)('"My hand is full!" -- Your Opponent'), (0, _dom.blockquote)('"I am almost out of card." -- Tyrande Whisperwind (2016)'), (0, _dom.h2)('Inputs'), (0, _dom.h3)('Your Info'), (0, _dom.input)('#p1S', { attrs: { type: 'number', placeholder: 'deck size' } }), (0, _dom.input)('#p1F', { attrs: { type: 'number', placeholder: 'fatigue tick' } }), (0, _dom.h3)('Opponent Info'), (0, _dom.input)('#p2S', { attrs: { type: 'number', placeholder: 'deck size' } }), (0, _dom.input)('#p2F', { attrs: { type: 'number', placeholder: 'fatigue tick' } }), (0, _dom.h3)('Play Sequence'), (0, _dom.button)('#brann', 'Brann'), (0, _dom.button)('#coldlight', 'Coldlight'), (0, _dom.button)('#gangup', 'Gangup'), (0, _dom.button)('#clear', '*Clear Sequence*'), (0, _dom.ul)(actions.map(function (it) {
	        return (0, _dom.li)(it);
