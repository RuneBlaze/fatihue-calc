...
/***/ function(module, exports, __webpack_require__) {
	...
	var symbol_observable_1 = __webpack_require__(7);
	var NO = {};
	function noop() { }
	function copy(a) {
	    var l = a.length;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = init([__webpack_require__(103), __webpack_require__(120)]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fatihue = __webpack_require__(127);
	
	function mkIntSg(sources, kw) {
	  return sources.DOM.select(kw).events('input').map(function (ev) {
	    return parseInt(ev.target.value);
	  }).startWith(0);
	}
	
	function App(sources) {
	  var p1S$ = mkIntSg(sources, '#p1S');
	  var p1F$ = mkIntSg(sources, '#p1F');
	  var p2S$ = mkIntSg(sources, '#p2S');
	  var p2F$ = mkIntSg(sources, '#p2F');
	
	  var brann$ = sources.DOM.select('#brann').events('click').startWith(false).mapTo('brann');
	  var coldlight$ = sources.DOM.select('#coldlight').events('click').startWith(false).mapTo('coldlight');
	  var gangup$ = sources.DOM.select('#gangup').events('click').startWith(false).mapTo('gangup');
	  var clear$ = sources.DOM.select('#clear').events('click').startWith(false).mapTo('clear');
	
	  var buttons$ = _xstream2.default.merge(brann$, coldlight$, gangup$, clear$);
	
	  var actionList$ = buttons$.fold(function (l, r) {
	    return r === 'clear' ? [] : l.concat(r);
	  }, []);
	
	  var parameters$ = _xstream2.default.combine(p1S$, p1F$, p2S$, p2F$);
	
	  var res$ = _xstream2.default.combine(parameters$, actionList$);
	
	  var fatihue$ = res$.map(function (_ref) {
	    var _ref2 = _slicedToArray(_ref, 2),
	        _ref2$ = _slicedToArray(_ref2[0], 4),
	        a = _ref2$[0],
	        b = _ref2$[1],
	        c = _ref2$[2],
	        d = _ref2$[3],
	    ...
	    return [[a, b, c, d], actions, fatihue(a, b, c, d, actions)];
	  });
	
	  var sinks = {
	    DOM: fatihue$.map(function (_ref3) {
	      var _ref4 = _slicedToArray(_ref3, 3),
	          _ref4$ = _slicedToArray(_ref4[0], 4),
	          a = _ref4$[0],
	          b = _ref4$[1],
	          c = _ref4$[2],
	          d = _ref4$[3],
	          ...
	          p1Dmg = _ref4$2.p1Dmg,
	          p2Dmg = _ref4$2.p2Dmg,
	          p2FutureDmg = _ref4$2.p2FutureDmg;
	
	      return (0, _dom.div)('.container', [(0, _dom.h1)('Hearthstone Mill Rogue Lethal Calculator'), (0, _dom.p)('This calculator helps the inexperienced mill rogue players (like me) determine lethal.'), (0, _dom.p)('All number parameters are by default 0.'), (0, _dom.blockquote)('"My hand is full!" -- Your Opponent'), (0, _dom.blockquote)('"I am almost out of card." -- Tyrande Whisperwind (2016)'), (0, _dom.h)('a', { attrs: { href: 'https://github.com/RuneBlaze/fatigue-calc' } }, ['Github']), (0, _dom.h2)('Inputs'), (0, _dom.h3)('Your Info'), (0, _dom.input)('#p1S', { attrs: { type: 'number', placeholder: 'deck size' } }), (0, _dom.input)('#p1F', { attrs: { type: 'number', placeholder: 'fatigue tick' } }), (0, _dom.h3)('Opponent Info'), (0, _dom.input)('#p2S', { attrs: { type: 'number', placeholder: 'deck size' } }), (0, _dom.input)('#p2F', { attrs: { type: 'number', placeholder: 'fatigue tick' } }), (0, _dom.h3)('Play Sequence'), (0, _dom.button)('#brann', 'Brann'), (0, _dom.button)('#coldlight', 'Coldlight'), (0, _dom.button)('#gangup', 'Gangup'), (0, _dom.button)('#clear', '*Clear Sequence*'), (0, _dom.ul)(actions.map(function (it) {
	        return (0, _dom.li)(it);
	      })), (0, _dom.h2)('Result'), (0, _dom.ul)([(0, _dom.li)('Damage to Opponent (this turn): ' + p2Dmg), (0, _dom.li)('Damage to You (this turn): ' + p1Dmg), (0, _dom.li)('Damage to Opponent (start of next turn): ' + p2FutureDmg)])]);
	    })
	  };
	  return sinks;
	}
...
/***/ function(module, exports) {
	...
	function fatihue (p1S, p1T, p2S, p2T, actions) {
	  let p1 = new Player(p1S, p1T)
	  let p2 = new Player(p2S, p2T)
	  ...
	  let p2Dmg = p2.damage
	  p2.draw()
	  let p2FutureDmg = p2.damage
	  return {
	    p1Dmg, p2Dmg, p2FutureDmg
	  }
	}
	
	module.exports = fatihue
